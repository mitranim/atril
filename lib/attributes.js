...
var Bind = (function () {
    ...
    Bind.prototype.phase = function () {
        ...
        var vm = this.element[atril_1.vmKey];
...
var TwoWay = (function () {
    ...
    TwoWay.prototype.phase = function () {
...
var For = (function () {
    ...
    For.prototype.step = function (value, index) {
        ...
        var scope = nodes[0][atril_1.scopeKey] || Object.create(this.scope);
        scope.$index = index;
        scope[this.key] = value[index];
        while (nodes.length) {
            var node = nodes.shift();
            node[atril_1.scopeKey] = scope;
...
var Class = (function () {
    ...
    Class.prototype.phase = function () {
        var result = this.expression(this.scope);
        if (result)
