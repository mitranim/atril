...
var If = (function () {
    function If() {
        ...
        while (container.hasChildNodes()) {
            ...
            tree_1.Trace.getOrAddTrace(child).isDomImmutable = true;
    ...
    For.prototype.step = function (value, index) {
        ...
        if (this.stash.length >= this.originals.length) {
            ...
            nodes = this.originals.map(function (node) {
                ...
                tree_1.Trace.getOrAddTrace(clone).isDomImmutable = true;
                return clone;
            });
        }
        while (nodes.length) {
            ...
            tree_1.Trace.getOrAddTrace(node).insertScope((_a = {
                    $index: index
                },
...
var Let = (function () {
    function Let() {
        ...
        if (!this.scope) {
            var trace = tree_1.Trace.getOrAddTrace(this.element);
            trace.insertScope();
